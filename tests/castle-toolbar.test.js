...
test('palette retains twelve original-order groups and a separate Dummy Step control', () => {
  ...
  assert.deepEqual(groups.map(([name]) => name), ['Walls', 'Stairs', 'Castle', 'Gatehouses',
    'Military', 'Industry', 'Units & Siege', 'Moat & Pitch', 'Food', 'Town', 'Good Things', 'Bad Things']);
