...
| Languages | Nine YAML catalogues, 1,727 messages each, checked for completeness/interpolation/references. Live language switching and Persian text direction without mirrored geometry verified. | Native-speaker review of every translated sentence. |
